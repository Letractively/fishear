package net.fishear.web.t5.jquery.mixins;
...
/**
 * 
 * Modified autocomplete mixin, that is able to store selected ID to separate form element.
 * 
 * You may pass parameter "targetId" which - if passed - tells client ID of field, that ID of selected object will be stored to.
 * 
 * @author raterwork
 *
 */
